---
layout: lesson
title: Lesson 7 &middot; Wiring And Coding The Second LED
...
1. Add the second LED using the wiring shown in the video.
2. Update your block-based program to control it.
3. Test both LEDs and verify that each behaves as intended.
