---
layout: lesson
title: Lesson 9 &middot; Triggering The Box Using A Button & IR Sensor
...
1. Follow the video to combine the button and IR sensor logic.
2. Test each input separately.
3. Test the complete box several times and troubleshoot any unreliable behavior.
4. Once everything works, try changing the program to give your Magic Box a new behavior.
...
1. Code your box to open half way with the button, but fully open with the IR sensor.
2. Code your box to open ONLY if both the button and IR sensor are triggered at the same time.
