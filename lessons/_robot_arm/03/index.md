...
There are IDEs to make video games, apps for your smartphone, websites and lots more.  The IDE that we will be using is designed to allow us to write code for our robot and to prepare that code to be sent out to our robot’s brain (Arduino Uno).
...
Your Chromebook has special secret features that we need to enable so that it will be able to communicate with our Arduino Uno.  Follow these steps to enable this cool feature.
...
1. Connect your Arduino Uno to your Chromebook using a USB cable.  A  light should turn on on your board.
...
Learn how to connect your board to your computer and upload code by watching this video.
